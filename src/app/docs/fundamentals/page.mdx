...
- **General Certificates**: Support broad initiatives through indirect funding mechanisms, allowing price discovery and valuation for the people, places, and purposes they represent (e.g., water conservation across a region)
- **Specific Certificates**: Create direct funding pathways to defined real assets, enabling targeted support for concrete projects (e.g., specific water conservation projects at identified properties)
