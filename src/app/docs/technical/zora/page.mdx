...
### Zora Creator 1155 Implementation
Our contracts are built on top of the Zora Creator 1155 implementation:
- Base: `0x5Eb5bABCEFEa846b220C82f222F00Df95934F5f0`
- Zora: `0xDB07C4525E82340A27077Ad258160928f271BB7F`
- Optimism: `0xF77330C8b1c41f2e44470763Cf9E3ACa78Db4381`
- Arbitrum: `0xC04050e04708b33302E30E5A0fB1e8c38F4EBbB0`

## Overview

Our implementation uses Zora's 1155 contracts and Coins contracts for different strategies:
...
2. **Zero ETH (Timed Sale Strategy)**
   - Enables Zora's secondary market functionality
   - Includes countdown period and minimum ETH requirements
   - Used for community-driven price discovery
   - Contract: `0x777777722D078c97c6ad07d9f36801e653E356Ae`

3. **ERC20 Price (e.g., USDC)**
...
4. **Fixed ETH Price**
   - Direct ETH payment
   - No secondary market functionality
   - Simple fixed price in ETH
   - Contract: `0x04E2516A2c207E84a1839755675dfd8eF6302F0a`

5. **Merkle Allowlist** _(Not Currently Used)_
   - Merkle tree-based access control
   - Supports per-address customization (price/quantity)
   - Contract: `0xf48172CA3B6068B20eE4917Eb27b5472f1f272C7`

   Allowlist may be added later. Premint is not supported.
...
### 2. Timed Sale (Zero ETH)

#### Fee Structure
Total fee: 0.000111 ETH (✧111)
...
#### Secondary Market
- Creates ERC20z token and Uniswap V3 pool (1% fee)
- Secondary price starts at 0.000111 ETH
- Requirements for market launch:
  1. Primary sale must end
  2. Minimum ETH threshold reached
  3. Market countdown completed
  4. Minimum mints met
