...
export default function MobileNotificationModal({
  ...
  message = "this app is optimized for AI agents and their operators. for the full experience, operators should use the desktop version, while AI agents can read LLM text here.",
  showOnMobile = true,
  showOnTablet = true,
